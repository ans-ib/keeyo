...
const I = {
  ...
  logo: '<svg width="30" height="30" viewBox="0 0 48 48" aria-hidden="true"><rect x="2.5" y="2.5" width="43" height="43" fill="var(--accent)" stroke="var(--border)" stroke-width="3"/><circle cx="24" cy="17.5" r="6.5" fill="none" stroke="#fff" stroke-width="3.4"/><path d="M24 24v13.5m0-5h7.5" stroke="#fff" stroke-width="3.4" stroke-linecap="square" fill="none"/></svg>',
